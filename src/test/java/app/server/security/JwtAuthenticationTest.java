...
class JwtAuthenticationTest {
    ...
    void uponSuccessfulAuthenticationAJsonWebTokenIsIssuedToTheUser() throws ParseException {
        UsernamePasswordCredentials creds = new UsernamePasswordCredentials("krystiankryszczak@wp.pl", "Slakteron!123");
        ...
        assertEquals("krystiankryszczak@wp.pl", bearerAccessRefreshToken.getUsername());
        ...
        assertEquals(OK, rsp.getStatus());
        assertEquals("krystiankryszczak@wp.pl", response.body());
    }
}