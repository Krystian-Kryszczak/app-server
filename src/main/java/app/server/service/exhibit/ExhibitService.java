...
public abstract class ExhibitService<T extends Exhibit<T>> {
    // ---------------------------------------------------------------------------------------------------- //
    ...
    // ---------------------------------------------------------------------------------------------------- //
    protected abstract Mono<Void> historyUserVote(String userHexId, String exhibitHexId, boolean up);
    protected abstract Mono<Void> historyUserCancelVote(String userHexId, String exhibitHexId);
    // ---------------------------------------------------------------------------------------------------- //
